        ...
        <div class="card">
            <div class="card-header mx-auto">
                <ul class="nav nav-pills nav-secondary nav-pills-no-bd" id="pills-tab-without-border" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-home-tab-nobd" href="/perusahaan/cari_kandidat" role="tab" aria-controls="pills-home-nobd" aria-selected="true">Baru</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab-nobd" href="/perusahaan/cari_kandidat/experience" role="tab" aria-controls="pills-profile-nobd" aria-selected="false">Berpengalaman</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/perusahaan/cari_kandidat" method="post">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-4">
