...
<html lang="en">
    ...
    <body>
        <div class="container">
            {{-- <h2 style="font-family: serif; line-height:40px" class="text-center text-primary">PT. SUKSES MANDIRI UTAMA</h2>
            <h6 class="text-center text-danger" style="line-height: 1px; font-size:15px">International Manpower Supplier & General Trade</h6>
            <h5 class="text-center text-black">NIB 81201182321740004</h5>
            <h4 class="text-center text-primary" style="line-height:5px">CABANG JAWA TIMUR</h4>
            <div class="text-center text-black" style="font-size:15px; text-transform:uppercase"><b>nib 81201182321740009</b></div>
            <div class="text-center" style="font-size: 10px; line-height:5px; font-weight:bold; color:blue">JL. Batu Amaril, No. 18,RT01/RW04, Kel. Pandanwangi, Kec. Blimbing, Kota Malang . Jawa Timur</div> 
            <div class="text-center" style="font-size: 10px; line-height:20px; font-weight:bold; color:blue">Telp:+62 341 4377537   Email:smusuksesmalang1@gmail.com</div>  --}}
            <hr>
            <div class="row">
                <div class="col">
            ...
            <h6 class="text-center" style="line-height:20px; text-transform:uppercase;">{{$kandidat->negara}}</h6>
            <div class="row" style="line-height:20px">
                <div class="col-8"></div>
                <div class="col-4">
                    <b class="bold float-start">NO: {{$kandidat->jenis_kelamin.$kandidat->kode_negara}}_{{$kandidat->id_kandidat+800}}</b>
                </div>
            </div>
            ...
            <div class="row">                
                <div class="col-9">
                    <div class="mt-3"><b class="" style="font-size:1rem;">B. FAMILY BACKGROUND</b></div>
                    <div class="row" style="line-height:20px">
                        <div class="col-3">
                    ...
                    <div class="row" style="line-height:20px">
                        ...
                        <div class="col-2">
                            <b class="bold">KERJAAN PASANGAN</b>
                        </div>
                        <div class="col-4">:
                            @if ($kandidat->nama_pasangan !== null)
            ...
            <div class="row">
                ...
                <div class="col-4 mt-3">
                    <img class="float-end img" src="/gambar/Set_badan/{{$kandidat->foto_set_badan}}" width="330" height="350" alt="">
                </div>
            </div>
            <div class="" style="height: 7rem;"></div>
            ...
            <div class="row my-3">
                <table class="table table-bordered border-black text-center">
                    ...
                    <tr style="line-height: 8px;">
                        ...
                        <th scope="col text-center" style="font-size:12px;">1</th>
                        <th scope="col text-center" style="font-size:12px;">2</th>
                        <th scope="col text-center" style="font-size:12px;">3</th>
                    </tr>
                    </thead>
                    ...
                    <tr>
                        <th>Alamat Majikan/Perusahaan</th>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="text-center"><b class="bold">No. Register : {{$kandidat->jenis_kelamin.$kandidat->kode_negara}}_{{$kandidat->id_kandidat+800}}</b></div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    :
                    <div class="col-2 ms-2" style="border-bottom: 2px dotted black;"></div>
                </div>
            </div>
            ...
            <div class="row mx-5 mb-5">
                <div class="col-2"></div>
                <div class="col-2 text-center"><div class="bold mt-3 " style="font-weight:bold;">Kepala Desa...........................</div></div>
                <div class="col-2"></div>
            </div>
            <div class="row mb-5">
                <div class="col-5"></div>
                (
                <div class="col-2"><div class="text-center bold mt-3" style="border-bottom: 2px dotted black;"></div></div>
                )
                <div class="col-5"></div>
            </div>
        </div>
        <div class="container">
            ...
            <div class=""><b class="bold">pihak ke I (satu) akan bekerja ke luar negeri dengan negara tujuan {{$kandidat->negara}} selama kontrak ..........(..........) tahun melalui PT. Sukses Mandiri Utama.</b></div>
            ...
            <div class="row mt-3">
                <div class="col-5"><b class="bold"></b></div>
                <div class="col-2 text-center"><b class="bold">Mengetahui :</b></div>
            ...
            <div class="row mt-3">
                <div class="col-2"></div>
                (
                <div class="col-2" style="border-bottom: 2px dotted black;"></div>
                )
                <div class="col-2"></div>
            </div>
        </div>
