					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="/Atlantis/examples/assets/img/chadengle.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="/Atlantis/examples/assets/img/mlane.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="/Atlantis/examples/assets/img/talha.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<li>
									<div class="notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="/Atlantis/examples/assets/img/profile2.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
													<span class="block">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="/Atlantis/examples/assets/img/profile.jpg" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="/Atlantis/examples/assets/img/profile.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Hizrian</h4>
						...
						<li class="nav-item active">
							...
							<div class="collapse" id="dashboard">
								<ul class="nav nav-collapse">
									<li>
										<a href="/Atlantis/examples/demo1/index.html">
											<span class="sub-item">Dashboard 1</span>
										</a>
									</li>
									<li>
										<a href="/Atlantis/examples/demo2/index.html">
